...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        if AUTH_CHANNEL and not await is_subscribed(client, query):
            await query.answer("Oversmartness doesn't Suit On You 😒",show_alert=True)
            return
        ident, file_id = query.data.split("#")
        files = (await get_file_details(file_id))[0]
        title = files.file_name
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕ Support ⭕', url='https://telegra.ph/Keerthy-Suresh-05-20'),
            InlineKeyboardButton('⭕ Updates ⭕', url='https://telegra.ph/Keerthy-Suresh-05-20')
            ],[
        ...
        buttons= [[
            ...
            InlineKeyboardButton('🚸 Powered By', url='https://telegra.ph/Keerthy-Suresh-05-20'),
...
async def auto_filter(client, message):
    ...
    if 2 < len(message.text) < 100:    
        ...
        if imdb and imdb.get('poster'):
            ...
            await message.reply_text(f"<b>Here What I Found In My Database For Your Search Query {search} ‌‌‌‌‎ </b>", reply_markup=InlineKeyboardMarkup(btn))
