...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('➕ Add Me To Your Groups ➕', url='http://t.me/SamanthaMoviesBot?startgroup=true')
            ],[
            InlineKeyboardButton('🔍 Search Here', switch_inline_query_current_chat=''),
            InlineKeyboardButton('🕵 Go Inline', switch_inline_query='')
            ],[
            InlineKeyboardButton('⭕ Join For Movies ⭕', url='https://telegra.ph/Keerthy-Suresh-05-20')
            ],[
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.message.edit('Succesfully Deleted All The Indexed Files in Bot.')
